...
public class Datasource {
    ...
    public List<Routine> loadRoutines() {
        ...
        routines.add(new Routine(R.string.routine_1));
        routines.add(new Routine(R.string.routine_2));
        routines.add(new Routine(R.string.routine_3));
        routines.add(new Routine(R.string.routine_4));
        routines.add(new Routine(R.string.routine_5));
        return routines;
    }
}
